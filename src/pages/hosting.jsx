...
const BLOCKS = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        type: "multifield",
        fields: [
          { label: "1 месяц:", key: "1.4_m1", placeholder: "___" },
          { label: "3 месяц:", key: "1.4_m3", placeholder: "___" },
        ],
      },
      {
      ...
      },
      {
        ...
        type: "multifield",
        fields: [
          { label: "Основной:", key: "1.7_main", placeholder: "___" },
          { label: "Вторичный:", key: "1.7_sec", placeholder: "___" },
        ],
      },
    ],
  },
    ...
    questions: [
      {
        ...
        type: "multifield",
        fields: [
          { label: "Кол-во серверов:", key: "2.1_srv", placeholder: "___" },
    ...
    questions: [
      {
        ...
        type: "multifield",
        fields: [
          { label: "Кто отвечает:", key: "3.1_who", placeholder: "___" },
          { label: "SLA (время ответа, мин):", key: "3.1_sla", placeholder: "___" },
        ],
      },
      {
    ...
    questions: [
      {
        ...
        fields: [
          ...
          { label: "Причина:", key: "5.1_why", placeholder: "___" },
        ],
      },
      {
      ...
      },
      {
        ...
        type: "multifield",
        fields: [
          { label: "Имя:", key: "5.4_name", placeholder: "___" },
          { label: "Роль:", key: "5.4_role", placeholder: "___" },
        ],
      },
      {
