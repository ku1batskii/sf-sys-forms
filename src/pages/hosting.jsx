    ...
    questions: [
      {
        ...
        fields: [
          ...
          { label: "Сколько тратит в месяц (₽):", key: "1.1_spend", placeholder: "___" },
      ...
      },
      {
        ...
        fields: [
          ...
          { label: "Что скажете такому клиенту при входящей заявке:", key: "1.2_say", placeholder: "___" },
        ],
      },
      {
        id: "1.3",
      ...
      },
      {
        ...
        fields: [
          ...
          { label: "Ожидаемая конверсия (%):", key: "1.4_conv", placeholder: "___" },
          { label: "Стоимость одного лида (₽):", key: "1.4_cac", placeholder: "___" },
      ...
      },
      {
        ...
        fields: [
          ...
          { label: "Другие страны СНГ:", key: "1.5_sng", placeholder: "___" },
          { label: "Дальнее зарубежье:", key: "1.5_world", placeholder: "___" },
        ],
      },
    ],
  },
    ...
    questions: [
      ...
      },
      {
        ...
        fields: [
          ...
          { label: "Причина 2 (с фактом):", key: "2.3_r2", placeholder: "___" },
          { label: "Причина 3 (с фактом):", key: "2.3_r3", placeholder: "___" },
        ],
      },
      {
        ...
        fields: [
          ...
          { label: "Чем донор ПОМОГАЕТ (какая репутация переносится):", key: "2.4_helps", placeholder: "___" },
          { label: "Чем донор МЕШАЕТ (какие ассоциации вредят):", key: "2.4_hurts", placeholder: "___" },
      ...
      },
      {
        ...
        type: "multifield",
        fields: [
          { label: "Нельзя говорить клиенту:", key: "2.5_client", placeholder: "___" },
          { label: "Нельзя говорить внутри команды (самообман):", key: "2.5_team", placeholder: "___" },
    ...
    questions: [
      {
        ...
        type: "multifield",
        fields: [
          { label: "ARPU — средняя выручка на клиента/мес (₽):", key: "3.1_arpu", placeholder: "___" },
          { label: "Допустимый CAC — стоимость привлечения (₽):", key: "3.1_cac", placeholder: "___" },
          { label: "Целевой LTV (₽):", key: "3.1_ltv", placeholder: "___" },
          { label: "LTV / CAC (должно быть ≥ 3):", key: "3.1_ratio", placeholder: "___" },
          { label: "Допустимый месячный churn (%):", key: "3.1_churn", placeholder: "___" },
          { label: "Payback period (месяцев):", key: "3.1_payback", placeholder: "___" },
        ],
      },
      {
        id: "3.2",
        ...
        fields: [
          ...
          { label: "3 месяца — клиентов / MRR:", key: "3.2_m3", placeholder: "___" },
          { label: "6 месяцев — клиентов / MRR:", key: "3.2_m6", placeholder: "___" },
          { label: "12 месяцев — клиентов / MRR:", key: "3.2_m12", placeholder: "___" },
      ...
      },
      {
        ...
        type: "multifield",
        fields: [
          { label: "Какой месячный убыток выдерживаем (₽):", key: "3.4_loss", placeholder: "___" },
          { label: "Сколько месяцев выдерживаем:", key: "3.4_months", placeholder: "___" },
    ...
    questions: [
      {
        ...
        fields: [
          ...
          { label: "Косвенный 2:", key: "4.1_i2", placeholder: "___" },
          { label: "Где вы обгоняете каждого из прямых:", key: "4.1_win", placeholder: "___" },
        ],
      },
      {
        id: "4.2",
        ...
        type: "multifield",
        fields: [
          { label: "Почему клиенты уходят от Timeweb / Selectel / Beget:", key: "4.2_why", placeholder: "___" },
          { label: "Что они не нашли там, но ищут у вас:", key: "4.2_need", placeholder: "___" },
    ...
    questions: [
      {
        ...
        type: "multifield",
        fields: [
          { label: "Кол-во физических серверов:", key: "5.1_srv", placeholder: "___" },
          { label: "Средняя плотность VM на сервер:", key: "5.1_vm", placeholder: "___" },
          { label: "Итого VM на старте:", key: "5.1_total", placeholder: "___" },
      ...
      },
      {
        ...
        type: "multifield",
        fields: [
          { label: "Версия:", key: "5.3_ver", placeholder: "___" },
          { label: "Тип лицензии:", key: "5.3_lic", placeholder: "owned / monthly" },
          { label: "Модуль Proxmox (название и версия):", key: "5.3_mod", placeholder: "___" },
          { label: "Кто настраивает и поддерживает:", key: "5.3_who", placeholder: "___" },
          { label: "План если WHMCS ломается:", key: "5.3_plan", placeholder: "___" },
        ],
      },
      {
      ...
      },
      {
        ...
        fields: [
          ...
          { label: "Цена за превышение (₽/ТБ):", key: "5.6_overage", placeholder: "___" },
        ],
      },
      {
        id: "5.7",
    ...
    questions: [
      ...
      },
      {
        ...
        fields: [
          ...
          { label: "Чек-лист первых настроек клиента:", key: "6.4_check", placeholder: "___" },
      ...
      },
      {
        ...
        fields: [
          ...
          { label: "Сколько миграций в месяц без перегрузки:", key: "6.5_cap", placeholder: "___" },
    ...
    questions: [
      ...
      },
      {
        ...
        fields: [
          ...
          { label: "Кто пишет контент:", key: "7.7_who", placeholder: "___" },
          { label: "Бюджет на SEO в месяц (₽):", key: "7.7_budget", placeholder: "___" },
  ...
  // ─── 08 ПРАВОВОЙ КОНТУР ───────────────────────────────────────
  {
    ...
    questions: [
      ...
      },
      {
        ...
        type: "multifield",
        fields: [
          { label: "Процедура при запросе от правоохранителей:", key: "8.5_law", placeholder: "___" },
          { label: "Процедура при DMCA / жалобах на клиентский контент:", key: "8.5_dmca", placeholder: "___" },
    ...
    questions: [
      {
        ...
        fields: [
          ...
          { label: "Риск 2:", key: "9.1_r2", placeholder: "___" },
          { label: "Риск 3:", key: "9.1_r3", placeholder: "___" },
          { label: "Риск 4:", key: "9.1_r4", placeholder: "___" },
          { label: "Риск 5:", key: "9.1_r5", placeholder: "___" },
        ],
      },
      {
        ...
        fields: [
          ...
          { label: "Кто имеет право объявить остановку:", key: "9.2_who", placeholder: "___" },
        ],
      },
      {
        id: "9.3",
        ...
        fields: [
          ...
          { label: "До какого этапа дошли:", key: "9.3_stage", placeholder: "___" },
          { label: "3 главных причины провала:", key: "9.3_why", placeholder: "___" },
          { label: "Какие из причин устранены сейчас:", key: "9.3_fixed", placeholder: "___" },
          { label: "Какие всё ещё присутствуют:", key: "9.3_remain", placeholder: "___" },
        ],
      },
      {
        id: "9.4",
        ...
        type: "multifield",
        fields: [
          { label: "Если уйдёт ключевой технический человек:", key: "9.4_tech", placeholder: "___" },
          { label: "Если ДЦ отзовёт услуги — план Б:", key: "9.4_dc", placeholder: "___" },
          { label: "Если WHMCS-лицензия будет отозвана — план Б:", key: "9.4_whmcs", placeholder: "___" },
    ...
    questions: [
      {
        ...
        fields: [
          ...
          { label: "Что происходит при задержке больше допустимой:", key: "10.1_over", placeholder: "___" },
        ],
      },
      {
        ...
        type: "multifield",
        fields: [
          { label: "Бюджет на запуск до первой выручки (₽):", key: "10.2_launch", placeholder: "___" },
          { label: "Бюджет на первые 6 месяцев работы (₽):", key: "10.2_run", placeholder: "___" },
          { label: "Источник финансирования:", key: "10.2_src", placeholder: "свои / партнёрские / заёмные" },
          { label: "Условия возврата если заёмные:", key: "10.2_terms", placeholder: "___" },
        ],
      },
      {
        id: "10.3",
      ...
      },
      {
        ...
        type: "multifield",
        fields: [
          { label: "ЛПР по стратегии (имя, роль):", key: "10.5_str", placeholder: "___" },
          { label: "ЛПР по бюджету (имя, роль):", key: "10.5_bud", placeholder: "___" },
          { label: "ЛПР по техническим решениям (имя, роль):", key: "10.5_tech", placeholder: "___" },
          { label: "Кто влияет без права вето:", key: "10.5_inf", placeholder: "___" },
          { label: "Кто может заблокировать запуск (право вето):", key: "10.5_veto", placeholder: "___" },
          { label: "Процедура разрешения конфликтов между ЛПР:", key: "10.5_conf", placeholder: "___" },
        ],
      },
      {
        id: "10.6",
        ...
        fields: [
          ...
          { label: "Если план по клиентам (3 мес) недовыполнен на 50%:", key: "10.6_clients", placeholder: "___" },
        ],
      },
    ],
  },
